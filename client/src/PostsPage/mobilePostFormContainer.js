          ...
          <div className="fixed inset-0 flex z-40">
            ...
            <div className="relative flex-1 flex flex-col w-full pt-5 pb-4 bg-white">
              <div className="absolute top-0 right-0 p-1">
                <button onClick={toggleMobilePostForm} className="flex items-center justify-center h-12 w-12 rounded-full focus:outline-none focus:bg-teal-200" aria-label="Close sidebar">
